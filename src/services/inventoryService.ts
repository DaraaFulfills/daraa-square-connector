...
export class InventoryService {
    public async inventoryCountUpdate(inventoryCountUpdatedParams: InventoryCountUpdatedParams): Promise<void> {      
        ...
        const catalog_url: string = "https://connect.squareup.com/v2/catalog/object/" + catalog_object_id;
        const coResponse = await fetch(catalog_url, {
            ...
            headers: {
                ...
                'Authorization': 'Bearer EAAAESLNkiGw6E_8PIY5BdNKfBLqp5sZ2CXmpb1QeRzayp6Q2Orep_idQBT8Z11x'
            },
            redirect: 'follow', 
        ...
        const itemVariationData: ItemVariationData = catalogObject.object.item_data.variations![0].item_variation_data;
